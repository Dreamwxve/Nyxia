 ...
 return (
  <div className="flex w-full flex-col items-center px-8 pb-8 pt-16 antialiased md:p-16">
   <div className="flex flex-col justify-center gap-4">
    <Image src={dashboardConfig.logo} alt="logo" quality={100} width={112} height={112} className="mx-auto size-28 min-h-28 min-w-28 rounded-full" />
    <Header1 className="!mb-0 !justify-center bg-gradient-to-b from-white to-neutral-400 box-decoration-clone bg-clip-text !text-center !font-black text-fill-transparent">Nyxia's Commands List</Header1>
