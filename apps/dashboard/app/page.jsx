        ...
        <div className="mt-3 h-48 overflow-hidden">
         <AnimatedList>
          {notifications.map((item) => (
           <figure key={`notification-${item.content}`} className="relative mx-auto min-h-fit w-full max-w-[400px] transform-gpu overflow-hidden transition-all duration-200 ease-in-out">
